...
begin
  ...
  begin
    ...
    try
      ...
      Conn.SetProp(prEmbParams, Trim(FParams.Text));
...
begin
  ...
  ConnectionParameters.EmbParams := FParams;
end;
...
begin
  ...
  MySQLConnection.SetProp(prEmbParams, Trim(FParams.Text));
end;
...
begin
  ...
  IConnection.SetProp(prEmbParams, Trim(FParams.Text));
end;

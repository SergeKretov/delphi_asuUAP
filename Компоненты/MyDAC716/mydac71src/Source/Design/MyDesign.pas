...
{$ENDIF}
  ...
  RegisterPropertyEditor(TypeInfo(_TStrings), TMyQuery, 'SQLLock', TDAPropertyEditor);
...
{$ENDIF}
  ...
  RegisterPropertyEditor(TypeInfo(_TStrings), TMyStoredProc, 'SQLLock', TDAPropertyEditor);
  ...
  RegisterPropertyEditor(TypeInfo(_TStrings), TMyUpdateSQL, 'LockSQL', TDAPropertyEditor);

...
{$DEFINE MyDAC}            {remove the 'x' to enable Data Access Components for MySQL}
...
{$ENDIF}
  ...
  ppStrtch, ppDsgnDB, ppTypes, MyAccess, MyClasses, ppFormWrapper, daDataView, daQueryDataView, ppModule,
  daDataModule, ppCtrls, ppVar, ppRelatv, MemDS, DBAccess, ppViewr, daDatMod,
  daDataVw, daQuery, daQClass, ppDBBDE, MydacVcl, MyScript;
...
type
  TmyEndUserSolution = class(TForm)
    ...
    ppLabel4: TppLabel;
    ppShape1: TppShape;
    MyDACQueryDataView1: TdaMyDACQueryDataView;
    MyTable1: TMyTable;

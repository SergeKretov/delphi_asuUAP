...
procedure AssignConnection(MyConnection: TMyConnection); cdecl;
...
var
  ExternalMyConnection: TMyConnection;
  FormList: TList;
  FormCount: integer;

procedure AssignConnection(MyConnection: TMyConnection); cdecl;
begin
  ExternalMyConnection := MyConnection;
end;
...
begin
  with TfmDllMain.Create(Application) do begin
    ...
    MyConnection.AssignConnect(ExternalMyConnection);
    MyQuery.Active := True;
    Show;
  end;
end;

...
begin
  ...
  case userType of
    1: begin
      ...
      begin
        showmessage('Ok. Вход в систему выполнен успешно.');
        ...
        mainform.StaticText1.Caption:='Текущий пользователь: Суперадминистратор';
        loginform.Close;
    ...
    2: begin
      ...
      begin
        ...
        mainform.GroupBox1.Visible:=true;
        mainform.StaticText1.Caption:='Текущий пользователь: Администратор офиса '+officeadminid;
        loginform.Close;
      end else showmessage('Неверный пароль!');
    end;
    3: begin
      ...
      begin
        ...
        mainform.SpeedButton8.Enabled:=false;
        mainform.GroupBox1.Visible:=true;
        mainform.StaticText1.Caption:='Текущий пользователь: '+dblookupcombobox1.Text;
        loginform.Close;
      end else showmessage('Неверный пароль!');
    end;
  end;

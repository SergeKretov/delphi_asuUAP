...
begin
  cardedit.Caption:='Редактирование карты '+dbtext1.Caption;
  cardedit.showmodal;
end;
...
var cnum:string;
begin
  cnum:=inputbox('Введите номер карты','Номер новой карты','0000000000');
  cardedit.Caption:='Добавление новой карты '+cnum;
